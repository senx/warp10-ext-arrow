...
public class ValueWarpField extends WarpField {
  ...
  public ValueWarpField(GeoTimeSerie.TYPE type) {
  ...
  public ValueWarpField(BufferAllocator allocator, GeoTimeSerie.TYPE type) {
    this(allocator, Type.valueOf(type.name()));
  }
