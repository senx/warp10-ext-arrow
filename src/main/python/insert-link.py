...
for filename in os.listdir(directory):
  if filename.endswith('.txt'):
    ...
    # Sentence to append
    sentence = f"\nMore information in the documentation [{function}](https://warpfleet.senx.io/browse/io.warp10/warp10-ext-arrow/2.0.3-uberjar/io.warp10/warp10-ext-arrow/{NAME}.mc2)\n"
